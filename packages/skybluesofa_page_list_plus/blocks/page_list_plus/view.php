...
$wrapperClasses = array('ccm-block-page-list-wrapper', 'sbs_plp_container');
...
<div class="<?php   echo $wrapperClasses; ?>" id="sbs_plp_container-<?php   echo $controller->getIdentifier()?>"
    ...
    <?php  
    echo Loader::element('title', array('controller' => $controller), 'skybluesofa_page_list_plus');
    echo Loader::element('form', array('controller' => $controller), 'skybluesofa_page_list_plus');
    echo Loader::element('rss', array('controller' => $controller), 'skybluesofa_page_list_plus');
    ?>
    ...
    <?php   } else { ?>
                    ...
                    <?php   if ($includeEntryText): ?>
                        <div class="ccm-block-page-list-page-entry-text">
                            ...
                            <?php   if ($controller->includeDate): ?>
                                <div class="ccm-block-page-list-date page-author"><?php /* echo $date */?><?php echo $user->getUserDisplayName(); ?></div>
                            <?php   endif; ?>
        ...
        <?php   echo Loader::element('pagination', array('controller' => $controller), 'skybluesofa_page_list_plus'); ?>
    <?php  
    }
    echo Loader::element('debug', array('controller' => $controller), 'skybluesofa_page_list_plus');
    ?>
</div>