...
?>
        ...
        <div class="checkbox">
            <label class="checkbox span3">
                ...
                <?php 
                echo t("Don't show current page in results.");
                ?>
            </label>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="pageAttributeFilterSelection"
                            ...
                            <?php 
                            if (in_array($standardPropertyHandle, array('cvName', 'cvDescription'))) {
                            ...
                            } elseif (in_array($standardPropertyHandle, array('cID'))) {
                            ...
                            } elseif (in_array($standardPropertyHandle, array('cvDatePublic', 'cDateModified'))) {
                            ...
                            } elseif (in_array($standardPropertyHandle, array('uID','cvAuthorUID','cvApproverUID'))) {
