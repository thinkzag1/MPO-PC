...
<div class="pageAttributeAdditionalValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array($values[0], 'is_empty', 'not_empty', 'matches_all', 'not_matches_all', 'querystring_all', 'not_querystring_all','querystring_contains','not_querystring_contains')) ? "display:none;" : ""); ?>">
...
<div class="pageAttributeDefaultValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array($values[0], 'querystring_any', 'querystring_all', 'not_querystring_all', 'querystring_contains', 'not_querystring_contains', 'less_than_querystring', 'less_than_or_equal_to_querystring', 'more_than_querystring', 'more_than_or_equal_to_querystring')) ? "" : "display:none;"); ?>">
