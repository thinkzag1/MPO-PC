...
<select name="pageAttributesUsedForFilter[<?php   echo $pageAttributeKeyID; ?>][filterSelection]"
    ...
    <option
        value="is_not_exactly" <?php   if ($filterSelection == 'is_exactly') print 'selected'; ?>><?php   echo t('selected page name is not'); ?></option>
    <option
    ...
    <option
        value="matches_all" <?php   if ($filterSelection == 'matches_all') print 'selected'; ?>><?php   echo t('matches current selected page attribute'); ?></option>
    <option
        value="not_matches_all" <?php   if ($filterSelection == 'not_matches_all') print 'selected'; ?>><?php   echo t('does not match selected page attribute'); ?></option>
...
<div class="pageAttributeAdditionalValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array($values[0], 'matches_all', 'querystring_all', 'not_matches_all', 'not_querystring_all')) ? "display:none;" : ""); ?>">
