...
<div class="pageAttributeAdditionalValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array('not_empty', 'is_empty', 'equals', 'yesterday', 'today', 'tomorrow', 'matches_all', 'querystring_all', 'not_matches_all', 'not_querystring_all')) ? "display:none;" : ""); ?>">
    <input name="pageAttributesUsedForFilter[<?php   echo $pageAttributeKeyID; ?>][val1]"
           value="<?php   echo $values[0]; ?>"><span class="pageAttributeAdditionalValueSelectionSecondary"
                                                   style="<?php   echo(in_array($filterSelection, array()) ? "display:none;" : ""); ?>"> <label
...
<div class="pageAttributeDefaultValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array($values[0], 'querystring_all', 'not_querystring_all')) ? "" : "display:none;"); ?>">
