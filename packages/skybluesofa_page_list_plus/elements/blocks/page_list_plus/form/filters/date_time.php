...
<div class="pageAttributeAdditionalValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array('not_empty', 'is_empty', 'equals', 'yesterday', 'today', 'tomorrow', 'future', 'not_future', 'matches_all', 'querystring_all', 'not_matches_all', 'not_querystring_all', 'less_than_match', 'less_than_querystring', 'less_than_or_equal_to_match', 'less_than_or_equal_to_querystring', 'more_than_match', 'more_than_querystring', 'more_than_or_equal_to_match', 'more_than_or_equal_to_querystring')) ? "display:none;" : ""); ?>">
