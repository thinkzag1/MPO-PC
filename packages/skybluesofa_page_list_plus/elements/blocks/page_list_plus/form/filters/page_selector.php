...
<div class="pageAttributeAdditionalValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array($values[1], 'matches_all', 'querystring_all', 'not_matches_all', 'not_querystring_all')) ? "display:none;" : ""); ?>">
...
<div class="pageAttributeDefaultValueSelection"
     style="margin-top:5px;<?php   echo(in_array($filterSelection, array($values[1], 'querystring_any', 'querystring_all', 'not_querystring_all', 'less_than_querystring', 'less_than_or_equal_to_querystring', 'more_than_querystring', 'more_than_or_equal_to_querystring')) ? "" : "display:none;"); ?>">
