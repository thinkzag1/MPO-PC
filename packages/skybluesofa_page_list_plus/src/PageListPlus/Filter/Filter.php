...
class Filter extends Object
{
    ...
    public static function add($handle, $name, $package = null)
    {
        ...
        if (self::canInstallFilterWithHandle($handle)) {
            $values = array($handle, $name, $packageId);
    ...
    protected function setFilterClass()
    {
        ...
        $class = "Concrete\\Package\\" . $packageName . "\\Src\\PageListPlus\\Filter\\" . $className;
        $this->filterClass = Core::make($class);

/*        $namespace = "Concrete\\Package\\" . $packageName . "\\Src\\PageListPlus\\Filter\\" . $className;
        $this->filterClass = new $namespace();
*/
    }
    ...
    public static function getByHandle($handle)
    {
        ...
        $filter = $db->GetRow($sql, array($handle, $pageListPlusPackage->getPackageID()));
