...
if ($ch->show_proforma()) {
    ...
    <div 	id="<?php echo $setname; ?>_proforma"
          class="jl_magic_tabs_proforma <?php echo $setname; ?> jl_magic_tabs_vertical_right_ccm jl_magic_tabs_vertical_right ccm-ui"
          style="display:none;"
          data-selected-class="active jl_magic_tabs_vertical_right_ccm_active"
          data-body-selected-class="jl_magic_tabs_vertical_right_ccm_tab_body"
