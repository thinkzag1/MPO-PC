...
if ($ch->show_proforma()) {
    ...
    <div 	id="<?php echo $setname; ?>_proforma"
          class="jl_magic_tabs_proforma <?php echo $setname; ?> jl_magic_tabs_vertical_right_starter jl_magic_tabs_vertical_right"
          style="display:none;"
          data-selected-class="jl_magic_tabs_vertical_right_starter_active"
          data-body-selected-class="jl_magic_tabs_vertical_right_starter_tab_body"
