...
/* ======================================================================================================================
  ...
  This version adds a ui-styled body wrapper. Noite the data-body-selected-class.
 */
...
if ($ch->show_proforma()) {
    ...
    <div 	id="<?php echo $setname; ?>_proforma"
          ...
          data-body-selected-class="ui-tabs-panel ui-widget-content ui-corner-bottom jl-magi-tabs-ui-container"
