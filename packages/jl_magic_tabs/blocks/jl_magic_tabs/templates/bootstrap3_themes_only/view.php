...
/* ======================================================================================================================
  ...
  This template uses bootstrap3 classes, as provided by the Elemental theme or other bootstrap based tabs
...
if ($ch->show_proforma()) {
    ...
    <div 	id="<?php echo $setname; ?>_proforma"
          class="jl_magic_tabs_proforma jl_magic_tabs_bootstrap3 <?php echo $setname; ?>"
          style="display:none;"
