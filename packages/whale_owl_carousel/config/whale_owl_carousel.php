...
/*
THIS IS A CONFIG FILE, CONTAINS AVAILABLE CONFIGS FOR THIS ADD-ON.
...
//var_dump(Config::get('whale_owl_carousel.permission'));
...
return array(
    ...
    'notice_list' => '',
    'notice_form' => '',
    'animate_text' => 'Whale', //dashboard animation live text
);
