...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" media="only screen and (max-device-width: 813px)" href="../assets/css/mobile.css" /><!-- Global site tag (gtag.js) - Google Ads: 461860416 -->
...
<!-- Event snippet for General Litigation New Ads conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-461860416/aMfLCO_NqcsCEMDcndwB'});
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5GS49TL"
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div class="BgsDark">
            <div class="container">
                <div class="FormDatatext col-md-8 col-lg-8 col-xs-8 col-sm-8">
                    <h1 style="text-transform: initial !important;"><?php echo $data['h1']; ?><hr></h1>
                    ...
                    <div class="FormDataShow">
                        ...
                        <section>
                            <form class="" action="submit.php">
                                ...
                                <input type="submit" class="btns" id="generallitigation" value="Submit your Request">
                            </form>
                        </section>
                    </div>
                </div>
        ...
        <div class="BgFoot">
            <div class="container">
                ...
                <a href="#formright" class="btns">Speak with an Attorney</a>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 footer-legal-two">
                            ...
                            <p style="text-align: center;">© 2021&nbsp;Midgett&nbsp;Preti Olansen&nbsp; •&nbsp; Site Powered By&nbsp;<a href="http://www.studiocenter.com/" target="_blank">Studio Center</a></p>
